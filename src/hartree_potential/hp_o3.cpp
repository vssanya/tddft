...
double Dn_0_o3(int n, sh_grid_t const* grid, double const* f) {
...
void Dn_init_o3(int n, double F[1], sh_grid_t const* grid, double const* f) {
  F[0] = Dn_0_o3(n, grid, f);
}

double Dn_next_o3(int n, double F[1], int ir, sh_grid_t const* grid, double const* f) {
  if (ir == 0) {
    return F[ir];
  }
...
double Un_0_o3(int n, sh_grid_t const* grid, double const* f) {
  return 0.0;
}

void Un_init_o3(int n, double F[1], sh_grid_t const* grid, double const* f) {
  F[0] = Un_0_o3(n, grid, f);
}

double Un_next_o3(int n, double F[1], int ir, sh_grid_t const* grid, double const* f) {
  if (ir == grid->n[iR]-1) {
